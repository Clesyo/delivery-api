...
import br.com.delivery.dtos.ErrorFormDto;
...
public class RestResponseErrorHandler {
	 ...
	 * 
	 * @ExceptionHandler(AccessDeniedException.class) public ErrorFormDto
	 * handle(AccessDeniedException exception) { return new ErrorFormDto("Error",
	 * "Usuário não tem permissão para acessar o recurso."); }
	 * 
	 * @ResponseStatus(code = HttpStatus.UNAUTHORIZED)
	 * 
	 * @ExceptionHandler(NotAuthorizedException.class) public ErrorFormDto
	 * handle(NotAuthorizedException exception) { String message =
	 * exception.getMessage(); String error = StringUtils.hasLength(message) ?
	 * message : "Usuário não tem permissão para acessar o recurso"; ErrorFormDto
	 * errorFormDto = new ErrorFormDto("Error", error); return errorFormDto; }
	 */
